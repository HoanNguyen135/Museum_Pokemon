...
const valuableCardsFetcher = (params: {
  page: number;
  pageSize: number;
  query?: string;
}) => {
...
// ─── Latest Sets fetcher ────────────────────────────────────────────────
const latestSetsFetcher = (params: {
  page: number;
  pageSize: number;
  query?: string;
}) =>
...
const HomeScreen = () => {
  ...
  // Most Valuable Cards
  const valuableCards = usePaginatedFetch(valuableCardsFetcher, {
    pageSize: 10,
  });
    ...
    <SafeViewMain>
      ...
      <View className="p-6 flex-row justify-between items-center">
        <View className="flex-row">
          ...
          <View className="self-center">
            <TextCustom className="ml-5 text-white font-bold">
              {userData?.name}
            </TextCustom>
      ...
      <Animated.View
        ...
        <SectionHeader
          ...
          onSeeAll={() =>
            navigate(SCREEN_NAME.FULL_LIST, {
              mode: 'MostValuable',
